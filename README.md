...
```Groovy
compile 'com.google.cloud:pubsublite-kafka:0.5.0'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "pubsublite-kafka" % "0.5.0"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-pubsublite-kafka/tree/master/samples) directory.
