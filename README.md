...
<!-- {x-version-update-start:pubsublite-kafka:released} -->
...
```Groovy
implementation 'com.google.cloud:pubsublite-kafka:1.2.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "pubsublite-kafka" % "1.2.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/pubsublite-kafka/1.2.0
